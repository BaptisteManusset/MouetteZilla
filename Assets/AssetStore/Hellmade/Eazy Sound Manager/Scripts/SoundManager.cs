...
namespace Hellmade.Sound
{
  ...
  public class SoundManager : MonoBehaviour
  {
    ...
    #region UI Functions
    public static int Playhover()
    {
      return PlayAudio(Audio.AudioType.Sound, SoundLibrary.instance.uiButtonHover, 1f, false, false, 0f, 0f, -1f, null);

    }
    public static int PlayClick()
    {
      return PlayAudio(Audio.AudioType.Sound, SoundLibrary.instance.uiButtonClick, 1f, false, false, 0f, 0f, -1f, null);
    }
